...
We can use the ![](../.gitbook/assets/image%20%2823%29.png) block to make drawing shapes a lot easier! You can see below a script to draw a square. It is, of course, much easier to create this script.
...
Using a ![](../.gitbook/assets/image%20%2823%29.png) to draw the following regular shapes:
...
Complete the code below to draw a star.
 ...
 ![](../.gitbook/assets/image%20%2867%29.png) ![](../.gitbook/assets/image%20%2873%29.png) 
