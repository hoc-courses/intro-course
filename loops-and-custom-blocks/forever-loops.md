...
**Hint**: ![](../.gitbook/assets/image%20%2815%29.png) and ![](../.gitbook/assets/image%20%28136%29.png) are reporters in the **Sensing** palette; they tell you where the mouse is pointing.
...
* You can change the color of each sprite by clicking the color input in that sprite's ![](../.gitbook/assets/image%20%2831%29.png) block \(found under the **Pen** tab\), choosing a color, and then clicking on the the block itself \(to run the block and actually set the color\). Don't worry about matching the colors in the animation exactly!
* Pay close attention to what each of the other sprites is doing in the animation above. You will need to modify the **x** and **y** inputs in each sprite's ![](../.gitbook/assets/image%20%28125%29.png) block using simple formulas, with ![](../.gitbook/assets/image%20%2895%29.png) and ![](../.gitbook/assets/image%20%2828%29.png) .
