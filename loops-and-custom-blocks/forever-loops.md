...
**Hint**: ![](../.gitbook/assets/image%20%2812%29.png) and ![](../.gitbook/assets/image%20%2895%29.png) are reporters in the **Sensing** palette; they tell you where the mouse is pointing.
...
* Pay close attention to what each of the other sprites is doing in the animation above. You will need to modify the **x** and **y** inputs in each sprite's ![](../.gitbook/assets/image%20%2888%29.png) block using simple formulas, with ![](../.gitbook/assets/image%20%2867%29.png) and ![](../.gitbook/assets/image%20%2823%29.png) .
