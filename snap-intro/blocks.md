...
Look at the **Motion** tab. Under this tab you will find a bunch of blocks that correspond to motion-like actions. For example, click on the ![](../.gitbook/assets/image%20%28101%29.png) block, drag it to the scripting area, and drop it anywhere in the scripting area.
